...
print(blockchain.chain[1]['Current_hash'])

# Write Task 03 code from below
if blockchain.chain[0]['Current_hash'] == blockchain.chain[1]['previous_hash']:
    print("Hash of current block matches")
else:
    print("oh no !!!!!! HASHHH DOESNTT MATCHHHHH ABORTT MISSIONN ABORTTT RUNN RUNNN RUNNNNNNN!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
